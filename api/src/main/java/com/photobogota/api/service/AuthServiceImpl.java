...
public class AuthServiceImpl implements IAuthService {
        ...
        public LoginResponseDTO login(LoginRequestDTO request) {
                ...
                UsuarioAuth usuario = usuarioAuthRepository
                                .findByEmailOrNombreUsuario(request.getLogin(), request.getLogin())
                ...
                // 4. Obtener el nivel y puntos del usuario (solo los miembros tienen
                // nivel/puntos)
                Integer nivel = null;
                Long puntos = null;
                ...
                // Invalida o elimina las sesiones anteriores del mismo usuario antes de
                // registrar la nueva
                sesionRepository.deleteByUsuarioId(usuario.getId().toString());

                // Se usa new ObjectId() para garantizar un _id único por sesión
